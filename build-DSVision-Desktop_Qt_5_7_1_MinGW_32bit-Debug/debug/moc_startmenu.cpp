...
#include "../../project/View/startmenu.h"
...
QT_MOC_LITERAL(1, 10, 10), // "exitSystem"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14), // "initTreeWindow"
QT_MOC_LITERAL(4, 37, 17), // "initAVLTreeWindow"
QT_MOC_LITERAL(5, 55, 19), // "initSplayTreeWindow"
QT_MOC_LITERAL(6, 75, 16), // "initHFTreeWindow"
QT_MOC_LITERAL(7, 92, 15), // "initLHeapWindow"
QT_MOC_LITERAL(8, 108, 16) // "initRBTreeWindow"

    },
    "StartMenu\0exitSystem\0\0initTreeWindow\0"
    "initAVLTreeWindow\0initSplayTreeWindow\0"
    "initHFTreeWindow\0initLHeapWindow\0"
    "initRBTreeWindow"
};
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->exitSystem(); break;
        case 1: _t->initTreeWindow(); break;
        case 2: _t->initAVLTreeWindow(); break;
        case 3: _t->initSplayTreeWindow(); break;
        case 4: _t->initHFTreeWindow(); break;
        case 5: _t->initLHeapWindow(); break;
        case 6: _t->initRBTreeWindow(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject StartMenu::staticMetaObject = {
    { &DSWidget::staticMetaObject, qt_meta_stringdata_StartMenu.data,
...
void *StartMenu::qt_metacast(const char *_clname)
{
    ...
    return DSWidget::qt_metacast(_clname);
}

int StartMenu::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = DSWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 7)
