...
public:
    ...
    void DSVBSTInsert(int key);
    void DSVBSTErase(int key);
    void DSVBSTFind(int key);
    void DSVBSTClear();
    void DSVAVLTreeInsert(int key);
    void DSVAVLTreeErase(int key);
    void DSVAVLTreeFind(int key);
    void DSVAVLTreeClear();
    void DSVSplayTreeInsert(int key);
    void DSVSplayTreeErase(int key);
    void DSVSplayTreeFind(int key);
    void DSVSplayTreeClear();
    void DSVLeftistHeapInsert(int key);
    void DSVLeftistHeapErase(int key);
    void DSVLeftistHeapClear();
    void DSVHFTreeInsert(int key);
    void DSVHFTreeErase(int key);
    void DSVHFTreeFind(int key);
    void DSVHFTreeClear();
    void DSVRBTInsert(int key);
    void DSVRBTErase(int key);
    void DSVRBTFind(int key);
    void DSVRBTClear();
